  ...
  export default {
    ...
    data() {
      return {
        translateHeaders: [
        {
            title: "defect_reason.table.action",
            value: "action",
            sortable: false,
            align: "end",
            fixed: true,
        ...
        { title: "defect_reason.table.mill_code", value: "mill.code", sortable: true },
        { title: "defect_reason.table.code", value: "code", sortable: true },
        { title: "defect_reason.table.name", value: "name", sortable: true },  
        { title: "defect_reason.table.type", value: "type", sortable: true },      
        { title: "defect_reason.table.desc", value: "desc", sortable: true },
        { title: "defect_reason.table.required_roles", value: "required_roles", sortable: true },
