...
import DeleteDialog from "@/site/DeleteDialog.vue";

import NewEditSheet from "@/site/NewEditSheet.vue";
...
export default {
  ...
  data() {
    return {
      translateHeaders: [
        {
          title: "site.table.action",
          value: "action",
          sortable: false,
          align: "center",
          fixed: true
        },
        { title: "site.table.code", value: "code", sortable: true },
        { title: "site.table.site_type_code", value: "site_type.code", sortable: true },
        { title: "site.table.mill_code", value: "mill.code", sortable: true },
        { title: "site.table.name", value: "name", sortable: true },
        { title: "site.table.description", value: "desc", sortable: true },
        { title: "site.table.latitude", value: "latitude", sortable: true },
        { title: "site.table.longitude", value: "longitude", sortable: true },
      ],
