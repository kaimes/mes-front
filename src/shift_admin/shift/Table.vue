...
<script>
import DeleteDialog from "@/shift_admin/shift/DeleteDialog.vue";

import NewEditSheet from "@/shift_admin/shift/NewEditSheet.vue";
  ...
  data() {
    return {
      translateHeaders: [
        ...
        {
          title: "shift.table.action",
          value: "action",
          sortable: false,
          align: "center",
          fixed: true
        },
        { title: "shift.table.mill_code", key: "mill.code"},
        { title: "shift.table.code", value: "code", sortable: true },
        { title: "shift.table.name", value: "name", sortable: true },
        { title: "shift.table.desc", value: "desc", sortable: true },
        { title: "shift.table.shift_day", value: "shift_day", sortable: true },
        { title: "shift.table.shift_number", value: "shift_no", sortable: true },
        { title: "shift.table.shift_start", value: "shift_start", sortable: true },
        { title: "shift.table.shift_end", value: "shift_end", sortable: true },
      ],
