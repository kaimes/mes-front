...
const tableHeaders = computed(() => [
  { title: t("semi_hold_reason.table.action"), key: "action", width: 130, fixed: true },
  { title: t("semi_hold_reason.table.mill_code"), key: "mill.code" },
  { title: t("semi_hold_reason.table.code"), key: "code" },
  { title: t("semi_hold_reason.table.type"), key: "type" },
  { title: t("semi_hold_reason.table.name"), key: "name" },
  { title: t("semi_hold_reason.table.desc"), key: "desc" },
]);
const tableList = ref([]);
const total = ref(0);
