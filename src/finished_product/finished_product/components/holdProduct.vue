<template>
  <v-dialog v-model="visible" max-width="800" :close-on-back="false" persistent>
    <v-card title="Piece Hold">
      ...
      <div class="text-subtitle-2 ml-4 mr-4 mb-2 mt-2">List of hold type</div>
...
const tableHeaders = ref([
  ...
  { title: "Order Number", key: "order_item.order.order_code", sortable: false },
  { title: "Line Item Number", key: "line_item_code", minWidth: 120, sortable: false },
  { title: "Spec Code", key: "spec_code", sortable: false },
  { title: "Location", key: "location", sortable: false },
  { title: "Defect", key: "defect_reason.name", sortable: false },
