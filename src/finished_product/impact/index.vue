...
const tableHeaders = ref([
  ...
  {title: "Thickness From(mm)", key: "thick_from"},
  {title: "Thickness To(mm)", key: "thick_to"},
  {title: "Notch", key: "location"},
  {title: "Frequency", key: "impact_units"},
  {title: "Temperature(°C)", key: "temp_units"},
  {title: "Impact1 Avg", key: "ave_value_1"},
  {title: "Impact1 Min", key: "min_value_1"},
  {title: "Impact2 Avg", key: "ave_value_2"},
  {title: "Impact2 Min", key: "min_value_2"},
  {title: "Impact3 Avg", key: "ave_value_3"},
  {title: "Impact3 Min", key: "min_value_3"},
]);
const tableList = ref([]);
const total = ref(0);
