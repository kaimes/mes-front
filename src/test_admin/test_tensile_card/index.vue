      ...
      <v-expansion-panels class="spec-panels" v-model="panel" multiple>
        ...
        <v-expansion-panel>
          ...
          <v-expansion-panel-text clss="spec-panels-text">
            <v-row align="center">
              <v-col cols="1">
                <div class="text-subtitle-2 font-weight-regular	mb-2">Yield</div>
                <v-text-field density="compact" variant="underlined" v-model="form.tensile_result_yield"
                              placeholder="Yield" bg-color="white" clearable :disabled="!save"></v-text-field>
              </v-col>
              <v-col cols="1">
                <div class="text-subtitle-2 font-weight-regular	mb-2">Tensile</div>
                <v-text-field density="compact" variant="underlined" v-model="form.tensile_result_tensile"
                              placeholder="Tensile" bg-color="white" clearable :disabled="!save"></v-text-field>
              </v-col>
              <v-col cols="1">
                <div class="text-subtitle-2 font-weight-regular	mb-2">Elongation</div>
                <v-text-field density="compact" variant="underlined" v-model="form.tensile_result_elongation"
                              placeholder="Elongation" bg-color="white" clearable :disabled="!save"></v-text-field>
              </v-col>
              <v-col cols="1">
                <div class="text-subtitle-2 font-weight-regular	mb-2">Elong Code</div>
                <v-text-field density="compact" variant="underlined" v-model="form.tensile_result_elong_code"
                              placeholder="Elong Code" bg-color="white" clearable :disabled="!save"></v-text-field>
              </v-col>
              <v-col cols="1">
                <div class="text-subtitle-2 font-weight-regular	mb-2">Orientation</div>
                <v-text-field density="compact" variant="underlined" v-model="form.tensile_result_orientation"
                              placeholder="Orientation" bg-color="white" clearable :disabled="!save"></v-text-field>
              </v-col>
              <v-col cols="1">
                <div class="text-subtitle-2 font-weight-regular	mb-2">Standard</div>
                <v-text-field density="compact" variant="underlined" v-model="form.tensile_result_standard"
                              placeholder="Standard" bg-color="white" clearable :disabled="!save"></v-text-field>
              </v-col>
              <v-col cols="1">
                <div class="text-subtitle-2 font-weight-regular	mb-2">Samplc Thickness</div>
                <v-text-field density="compact" variant="underlined" v-model="form.tensile_result_sample_thickness"
                              placeholder="Samplc Thickness" bg-color="white" clearable :disabled="!save"></v-text-field>
              </v-col>
            </v-row>
          </v-expansion-panel-text>
        </v-expansion-panel>
        <v-expansion-panel>
          ...
          <v-expansion-panel-text clss="spec-panels-text">
            <v-row align="center">
              <v-col cols="3">
                <div class="text-subtitle-2 font-weight-regular	mb-2">Width</div>
                <v-text-field v-model="form.type" density="compact" variant="underlined"
                              placeholder="Width" bg-color="white" clearable disabled></v-text-field>
              </v-col>
              <v-col cols="3">
                <div class="text-subtitle-2 font-weight-regular	mb-2">Thickness</div>
                <v-text-field v-model="form.k_number" density="compact" variant="underlined"
                              placeholder="Thickness" bg-color="white" clearable disabled></v-text-field>
              </v-col>
              <v-col cols="3">
                <div class="text-subtitle-2 font-weight-regular	mb-2">Area</div>
                <v-text-field v-model="form.k_value" density="compact" variant="underlined"
                              placeholder="Area" bg-color="white" clearable disabled></v-text-field>
              </v-col>
              <v-col cols="3">
                <div class="text-subtitle-2 font-weight-regular	mb-2">YS</div>
                <v-text-field v-model="form.k_value" density="compact" variant="underlined"
                              placeholder="YS" bg-color="white" clearable disabled></v-text-field>
              </v-col>
              <v-col cols="3">
                <div class="text-subtitle-2 font-weight-regular	mb-2">N/MM2</div>
                <v-text-field v-model="form.k_value" density="compact" variant="underlined"
                              placeholder="N/MM2" bg-color="white" clearable disabled></v-text-field>
              </v-col>
              <v-col cols="3">
                <div class="text-subtitle-2 font-weight-regular	mb-2">UTS</div>
                <v-text-field v-model="form.k_value" density="compact" variant="underlined"
                              placeholder="UTS" bg-color="white" clearable disabled></v-text-field>
              </v-col>
              <v-col cols="3">
                <div class="text-subtitle-2 font-weight-regular	mb-2">N/MM2</div>
                <v-text-field v-model="form.k_value" density="compact" variant="underlined"
              ...
              <v-col cols="3">
                <div class="text-subtitle-2 font-weight-regular	mb-2">Elongation</div>
                <v-text-field v-model="form.k_value" density="compact" variant="underlined"
                              placeholder="Elongation" bg-color="white" clearable disabled></v-text-field>
              </v-col>
            </v-row>
          </v-expansion-panel-text>
        </v-expansion-panel>
...
const data = reactive({
  ...
  form: {
    ...
    tensile_result_yield: undefined,
    tensile_result_tensile: undefined,
    tensile_result_elongation: undefined,
    tensile_result_elong_code: undefined,
    tensile_result_orientation: undefined,
    tensile_result_standard: undefined,
    tensile_result_sample_thickness: undefined,
