  ...
  <div class="a6">
    <div class="d-flex position-relative justify-center align-center mb-6">
      <div class="text-subtitle-1 font-weight-bold text-center">
        === RESISTIVITY PRINT TEST CARD ===<br>
        === MEDIUM SECTION MILL ===
      </div>
      ...
      <table class="table-one" border="0">
        ...
        <tr>
          <td>&emsp;&emsp;&ensp; {{ tableData?.resistivity_object?.check_digit_1 }}</td>
      </tr>
        <tr>
        ...
        <tr>
          <td>MAX RESISTIVITY =&emsp;&emsp;&emsp;MICRO OHM CM</td>
        </tr>
        <tr>
          <td>TEMPERATURE =&emsp;&emsp;&emsp;DEG C</td>
        </tr>
        </tbody>
      </table>
      ...
      <table class="table-two">
        <thead>
        <tr>
          <th style="border-right:  solid black; height: 35px; text-align: center; vertical-align: top;"></th>
          <th  style="border-right:  solid black; height: 35px; text-align: center; vertical-align: top;">TEMP.</th>
          <th  style="border-right:  solid black; height: 35px; text-align: center; vertical-align: top;">HUMID.</th>
          <th  style="border-right:  solid black; height: 35px; text-align: center; vertical-align: top;">DIST.</th>
          <th  style="border-right:  solid black; height: 35px; text-align: center; vertical-align: top;">VOLT.</th>
          <th  style="border-right:  solid black; height: 35px; text-align: center; vertical-align: top;">CURR.</th>
          <th  style="border-right:  solid black; height: 35px; text-align: center; vertical-align: top;">RESIS.</th>
        </tr>
        <br/>
        <br/>
        </thead>
