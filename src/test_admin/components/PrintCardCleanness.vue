<template>
  <div class="a6">
    ...
    <table class="table-one">
      ...
      <tr>
        <td>&emsp;&emsp;&ensp; {{ tableData?.cleanness_object?.check_digit_1 }}</td>
      </tr>
      <tr>
      ...
      <tr>
        <td>TYPE =&emsp;&emsp;&emsp;</td>
      </tr>
      <tr>
        <td>K3 =&emsp;&emsp;&emsp;</td>
      </tr>
      <tr>
        <td>MAX =&emsp;&emsp;&emsp;</td>
      </tr>
      </tbody>
    </table>
