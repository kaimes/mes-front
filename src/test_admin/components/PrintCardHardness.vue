  ...
  <div class="a6">
    <div class="d-flex position-relative justify-center align-center mb-6">
      ...
      <table class="table-one">
        ...
        <tr>
          <td>&emsp;&emsp;&ensp; {{ tableData?.hardness_object?.check_digit_1 }}</td>
      </tr>
        <tr>
        ...
        <tr>
          <td>SPEC: &emsp;{{ tableData?.spec?.summary_name }}</td>
        </tr>
        <tr>
          <td>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;TESTED</td>
        </tr>
        <tr>
          <td>BHN MIN/MAX = {{ tableData?.hardness_object?.bhn_min_max }} HBW</td>
        </tr>
        <tr>
          <td>BALL SIZE/MM =  </td>
        </tr>
      ...
      <table class="table-two">
        <thead>
          <tr>
            ...
            <th style="border-right:  solid black; height: 20px; text-align: center; vertical-align: top;">1</th>
            <th style="border-right:  solid black; height: 20px; text-align: center; vertical-align: top;">2</th>
            <th style="border-right:  solid black; height: 20px; text-align: center; vertical-align: top;">3</th>
            <th style="border-right:  solid black; height: 20px; text-align: center; vertical-align: top;">4</th>
            <th style="border-right:  solid black; height: 20px; text-align: center; vertical-align: top;">5</th>
            <th style="border-right:  solid black; height: 20px; text-align: center; vertical-align: top;">AV.</th>
            <th style="height: 20px; text-align: center; vertical-align: top;"></th>
          </tr>
          <tr>
            <th style="border-right:  solid black; height: 100px; text-align: center; vertical-align: top;">--------------</th>
            <th style="border-right:  solid black; height: 100px; text-align: center; vertical-align: top;">--------------</th>
            <th style="border-right:  solid black; height: 100px; text-align: center; vertical-align: top;">--------------</th>
            <th style="border-right:  solid black; height: 100px; text-align: center; vertical-align: top;">--------------</th>
            <th style="border-right:  solid black; height: 100px; text-align: center; vertical-align: top;">--------------</th>
            <th style="border-right:  solid black; height: 100px; text-align: center; vertical-align: top;">--------------</th>
            <th style="border-right:  solid black; height: 100px; text-align: center; vertical-align: top;">--------------</th>
            <th style="height: 100px; text-align: center; vertical-align: top;"></th>
          </tr>
