      ...
      <v-expansion-panels class="spec-panels" v-model="panel" multiple>
        <v-expansion-panel>
          <v-expansion-panel-text clss="spec-panels-text">
            <v-row align="center">
              ...
              <v-col cols="3">
                <div class="text-subtitle-2 font-weight-regular	mb-2">Max</div>
                <v-text-field v-model="form.max" density="compact" variant="underlined"
                              placeholder="Max" bg-color="white" clearable disabled></v-text-field>
              </v-col>
              <v-col cols="3">
        ...
        <v-expansion-panel>
          <v-expansion-panel-text clss="spec-panels-text">
            <v-row align="center">
              <v-col cols="4">
                <div class="text-subtitle-2 font-weight-regular	mb-2">Rail Grade</div>
                <v-text-field density="compact" variant="underlined" v-model="data.query.rail_grade"
                              placeholder="Rail Grade" bg-color="white" clearable disabled></v-text-field>
              </v-col>
              <v-col cols="4">
                <div class="text-subtitle-2 font-weight-regular	mb-2">Max</div>
                <v-text-field density="compact" variant="underlined" v-model="data.query.max"
                              placeholder="Max" bg-color="white" clearable disabled></v-text-field>
              </v-col>
            </v-row>
          </v-expansion-panel-text>
        ...
        <v-expansion-panel>
          <v-expansion-panel-text clss="spec-panels-text">
            <v-row align="center">
              <v-col cols="4">
                <div class="text-subtitle-2 font-weight-regular	mb-2">Result</div>
                <v-text-field v-model="form.result" density="compact" variant="underlined"
                              placeholder="Result" bg-color="white" clearable :disabled="!save"></v-text-field>
              </v-col>
            </v-row>
          </v-expansion-panel-text>
        </v-expansion-panel>
