            ...
            >
              ...
              <template v-slot:default="{ isActive }">
                <v-card
                    ...
                    title="Are you sure to copy test cert extra details requirements?"
...
<script name="TestCertExtraDetails" setup>
...
const tableHeaders = ref([
  ...
  {title: "Ratio Element CD1", key: "ratio_element_cd1"},
  {title: "Ratio Element CD2", key: "ratio_element_cd2"},
  {title: "Ratio Element Min", key: "ratio_min"},
  {title: "Ratio Element Max", key: "ratio_max"},
]);
const tableList = ref([]);
const total = ref(0);
