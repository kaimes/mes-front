  ...
  >
    <v-form ref="editForm">
      <v-row>
        ...
        <v-col cols="6">
          <v-text-field
              v-model="form.tensile_min"
              :rules="rules.tensile_min"
              density="default"
              variant="underlined"
              label="Tensile Min"
              bg-color="white"
        ...
        <v-col cols="6">
          <v-text-field
              v-model="form.tensile_max"
              :rules="rules.tensile_max"
              density="default"
              variant="underlined"
              label="Tensile Max"
              bg-color="white"
        ...
        <v-col cols="6">
          <v-text-field
              v-model="form.reduction_in_area"
              density="default"
              variant="underlined"
...
const data = reactive({
  ...
  rules: {
    ...
    tensile_min: [
      value => {
        if (value && greaterThan(value, form.value.tensile_max)) {
          return 'tensile min must be smaller than tensile max'
        }
        return true;
      }
    ],
    tensile_max: [
      value => {
        if (value && greaterThan(form.value.tensile_min, value)) {
          return 'tensile max must be greater than tensile min'
        }
        return true;
      }
    ],
...
const handleShow = (data) => {
  if (data) {
    form.value = {
      ...
      reduction_in_area: data.reduction_in_area,
      fio: data.fio,
      pt: data.pt,
      pred: data.pred,
      tpsr: data.tpsr,
