...
const tableHeaders = ref([
  ...
  {title: "Spec Version", key: "spec.version", value:(item)=> item?.spec?.version},
  {title: "Version Status", key: "spec.version_status", value:(item)=> item?.spec?.version_status},
  {title: "Thickness From", key: "thick_from"},
  {title: "Thickness To", key: "thick_to"},
  {title: "Loc", key: "location"},
  {title: "Average RIA", key: "ria_ave_value"},
  {title: "Minimum RIA", key: "ria_min_value"},
  {title: "Ulitmate Tensile Strength (%)", key: "uts_min"},
]);
const tableList = ref([]);
const total = ref(0);
