<template>
  <v-container class="page" fluid>
            ...
            >
              ...
              <template v-slot:default="{ isActive }">
                <v-card
                    ...
                    title="Are you sure to copy bend test spec requirements?"
    ...
    Covering looks at if there is a bend test requirement. The bend frequency is ignored.
  </v-container>
</template>
...
const tableHeaders = ref([
  {title: "Action", key: "action", width: 130, sortable: false, fixed: true, align:"center"},
  ...
  {title: "Info", key: "info_only"},
  {title: "Direction", key: "direction"},
  {title: "Diameter", key: "diameter_mm"},
  {title: "Angle", key: "angle"},
  // {title: "Heat Code", key: "heat_code"},
  {title: "Freq", key: "freq"},
  {title: "Bend FIO", key: "fio"},
]);
const tableList = ref([]);
const total = ref(0);
